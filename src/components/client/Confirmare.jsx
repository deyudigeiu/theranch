    ...
    >
      ...
      {lastOrderId && (
        ...
        >
          ...
          <span style={{ fontSize: 14, fontWeight: 800, color: "#2D2D2D" }}>
            #{lastOrderId}
          </span>
        </div>
      )}
      ...
      >
        Denis a primit comanda ta și o va pregăti pentru livrare. Vei fi anunțat
        când e gata.
      </p>
        ...
        <button
          onClick={() => {
            const msg = encodeURIComponent(
              `Bună Denis! Am plasat comanda #${lastOrderId}. Mulțumesc! 🌿`
            );
